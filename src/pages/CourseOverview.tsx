            ...
            <div className="bg-white rounded-lg shadow-sm border p-8 mb-8">
              ...
              {course.completed && (
                <div className="mb-8 p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <p className="text-green-700 mt-1">Congratulations! You have successfully completed this course.</p>
              ...
              {course.quiz && (
                <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <h3 className="font-medium text-blue-900">Final Assessment</h3>
                  </div>
                  <p className="text-blue-800 text-sm mb-3">
                    Complete all lessons to unlock the final quiz. 
                    You need {course.quiz.passingScore}% to pass and earn your certificate.
                  </p>
                  {completedLessons.length === course.lessons.length && !course.completed && (
                    <Link
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-start space-x-2">
                  ...
                  <span>Understand fundamental safety principles</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  <span>Learn proper equipment usage and maintenance</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  <span>Identify and mitigate workplace hazards</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  <span>Apply safety protocols in real-world scenarios</span>
                </li>
              </ul>
            </div>
